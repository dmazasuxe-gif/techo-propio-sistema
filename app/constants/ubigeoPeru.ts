// UBIGEO del Perú: Departamentos, Provincias y Distritos oficiales
...
export const UBIGEO_PERU: UbigeoData = {
  ...
  AYACUCHO: {
    ...
    PARINACOCHAS: ["CORACORA", "CHUMPI", "CORONEL CASTAÑEDA", "PACAPAUSA", "PULLO", "PUYUSCA", "SAN FRANCISCO DE RIVACAYCO", "UPAHUACHO"],
  ...
  CUSCO: {
    ...
    "LA CONVENCION": ["SANTA ANA", "ECHARATE", "HUAYOPATA", "MARANURA", "OCOBAMBA", "QUELLOUNO", "KIMBIRI", "SANTA TERESA", "VILCABAMBA", "PICHARI", "INKAWASI", "VILLA VIRGEN", "VILLA KINTIARINA", "MEGANTONI", "KUMPIRUSHIATO", "CIELO PUNCO", "MANITEA", "UNION ASHANINKA"],
  ...
  HUANUCO: {
    HUANUCO: ["HUANUCO", "AMARILIS", "CHINCHAO", "CHURUBAMBA", "MARGOS", "QUISQUI (KICHKI)", "SAN FRANCISCO DE CAYRAN", "SAN PEDRO DE CHAULAN", "SANTA MARIA DEL VALLE", "YARUMAYO", "PILLCO MARCA", "YACUS", "SAN PABLO DE PILLAO"],
  ...
  JUNIN: {
    ...
    SATIPO: ["SATIPO", "COVIRIALI", "LLAYLLA", "MAZAMARI", "PAMPA HERMOSA", "PANGOA", "RIO NEGRO", "RIO TAMBO", "VIZCATÁN DEL ENE"],
  ...
  LIMA: {
    ...
    YAUYOS: ["YAUYOS", "ALIS", "ALLAUCA", "AYAVIRI", "AZANGARO", "CACRA", "CARANIA", "CATAHUASI", "CHOCOS", "COCHAS", "COLONIA", "HONGOS", "HUAMPARA", "HUANCAYA", "HUANGASCAR", "HUANTAN", "HUAÑEC", "LARAOS", "LINCHA", "MADEAN", "MIRAFLORES", "OMAS", "PUTINZA", "QUINCHES", "QUINOCAY", "SAN JOAQUIN", "SAN PEDRO DE PILAS", "TANTA", "TAURIPAMPA", "TOMAS", "TUPE", "VIÑAC", "VITIS"]
  },
  LORETO: {
    ...
    REQUENA: ["REQUENA", "ALTO TAPICHE", "CAPELO", "EMILIO SAN MARTIN", "MAQUIA", "PUINAHUANA", "SAQUENA", "SOPLIN", "TAPICHE", "JENARO HERRERA", "YAQUERANA"],
  ...
  MOQUEGUA: {
    "MARISCAL NIETO": ["MOQUEGUA", "CARUMAS", "CUCHUMBAYA", "SAMEGUA", "SAN CRISTOBAL", "TORATA", "SAN ANTONIO"],
